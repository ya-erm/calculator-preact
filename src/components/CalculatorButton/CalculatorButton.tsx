...
export const CalculatorButton: FC<IButtonProps> = ({
  text,
  icon,
  type = 'number',
  columns = 1,
...
export const ActionButton: FC<IButtonProps> = ({ text, type = 'action', ...other }) => {
  return <CalculatorButton text={text} type={type} {...other} />;
};
